 ...
 * {@link TemperatureFragment.OnTemperatureFragmentInteractionListener} interface
...
public class TemperatureFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onTemperatureFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnTemperatureFragmentInteractionListener) {
            mListener = (OnTemperatureFragmentInteractionListener) context;
        } else {
